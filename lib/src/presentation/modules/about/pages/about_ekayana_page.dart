      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            AspectRatio(
              aspectRatio: 360 / 200,
              child: Image.asset('asset/drawable/ekayana.png'),
            ),
            const SizedBox(
              height: 14,
            ),
                  ...
                  child: Row(
                    children: [
                      ...
                      ButtonComponent.icon(
                        onPressed: () {
                          const MapUtils.url(
                            url: "https://maps.app.goo.gl/dxpFSqHUA7G62VvC8",
                          ).launch();
                        },
                      ),
                    ],
